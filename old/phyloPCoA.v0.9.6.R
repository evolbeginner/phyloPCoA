...
check_clustering <- function(pcoa_res, grp_list){
...
cat("pcoa_2\n")
check_clustering(pcoa_2, grp_list)


##################################
# split by descedents of root
grp_list <- get_phylo_groups(tree)
plot_graphs(prop, log_prop_geomean, P, outfile, grp_list)

cat("groups determined by the two descedent clades of root\n")
cat("pcoa_1\n")
check_clustering(pcoa_1, grp_list)
cat("pcoa_2\n")
check_clustering(pcoa_2, grp_list)
